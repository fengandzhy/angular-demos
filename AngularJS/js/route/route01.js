...
// app.config(['$routeProvider',function($routeProvider){
//     $routeProvider
//         .when('/first',{templateUrl:'../../route/pages/1.html'})
//         .when('/second',{templateUrl:'../../route/pages/2.html'})
//         .when('/third',{
//             templateUrl:'../../route/pages/3.html',
//             controller:['$scope','$routeParams',function($scope,$routeParams){
...
//         })
//         .when('/fourth/:name/:height/:weight',{
//             templateUrl:'../../route/pages/4.html',
//             controller:['$scope','$routeParams',function($scope,$routeParams){
//                 console.log($routeParams.name);
//                 console.log($routeParams.height);
//                 console.log($routeParams.weight);
